...
var _user$project$Main$usersDecoder = A2(
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'users',
		_elm_lang$core$Json_Decode$list(_user$project$Main$userDecoder)));
var _user$project$Main$requestBody = _elm_lang$http$Http$jsonBody(
	_elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'query',
				_1: _elm_lang$core$Json_Encode$string('query { users { name } }')
			},
			_1: {ctor: '[]'}
		}));
...
var _user$project$Main$NewStuff = function (a) {
	return {ctor: 'NewStuff', _0: a};
};
var _user$project$Main$getStuff = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewStuff,
	A3(_elm_lang$http$Http$post, 'http://localhost:4000/api', _user$project$Main$requestBody, _user$project$Main$usersDecoder));
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$CreateNewUser),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						{ctor: '[]'},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('sandro'),
										_1: {
											ctor: '::',
